...
void EmitWarning(const std::string_view warning_msg,
  ...
  EmitWarning(lynxtron::JavascriptEnvironment::GetIsolate(), warning_msg,
              warning_type);
}
...
void EmitDeprecationWarning(const std::string_view warning_msg,
  ...
  EmitDeprecationWarning(lynxtron::JavascriptEnvironment::GetIsolate(),
                         warning_msg, deprecation_code);
}
